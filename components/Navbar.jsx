...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: "#about", label: "من نحن", icon: <FiInfo className="ml-2" /> },
    {
      ...
      submenu: [
        { href: "#services", label: "تركيب أرضيات رخام" },
        { href: "#seices", label: "تشطيب الجدران" },
        { href: "#serces", label: "سلالم رخامية" },
        { href: "#servis", label: "مطابخ رخام" },
        { href: "#service", label: "حمامات رخام" },
      ],
    },
